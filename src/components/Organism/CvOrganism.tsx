...
import {cvDetails, cvDetailsTwo, finalCvInterface} from "../../utils/TestUser";
...
export const CvOrganism = () => {
    const [userDetails, setUserDetails] = useState(cvDetails as finalCvInterface);
      const {base,grades,expectations,education,courses,experinceAtWork,portfolio,scrumProject,finalProject} = userDetails
