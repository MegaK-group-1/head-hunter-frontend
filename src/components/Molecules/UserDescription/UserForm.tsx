...
export function UserForm({
  ...
  const updatePortfolioUrls = (e: {
    target: { value: React.SetStateAction<string> };
  }) => {
    setPortfolioUrls(e.target.value);
  };
  const updateBonusProjectUrls = (e: {
    target: { value: React.SetStateAction<string> };
  }) => {
  ...
  const updateExpectedContractType = (e: {
    target: { value: React.SetStateAction<string> };
  }) => {
    setExpectedContractType(e.target.value);
  };
  const updateExpectedSalary = (e: {
    target: { value: React.SetStateAction<string> };
  }) => {
    setExpectedSalary(e.target.value);
  };
  const updateExpectedTypeWork = (e: {
    target: { value: React.SetStateAction<string> };
  }) => {
    setExpectedTypeWork(e.target.value);
  };
  const updateTargetWorkCity = (e: {
    target: { value: React.SetStateAction<string> };
  }) => {
    setTargetWorkCity(e.target.value);
  };
  const updateCanTakeApprenticeship = (e: {
    target: { value: React.SetStateAction<string> };
  }) => {
  ...
  const updateMonthsOfCommercialExp = (e: {
    target: { value: React.SetStateAction<string> };
  }) => {
...
//-------------------------------------------------------------------------------------------------------------------
// export function UserForm(props: { func: (arg0: { firstName: string; lastName: string; email: string; phone: string; githubUsername: string; portfolioUrls: string; bonusProjectUrls: string; bio: string; expectedContractType: string; expectedSalary: string; expectedTypeWork: string; targetWorkCity: string; canTakeApprenticeship: string; education: string; monthsOfCommercialExp: string; workExperience: string; courses: string; }) => void; }) {
//   const [firstName, setFirstName] = useState("");
//   const [lastName, setLastName] = useState("");
//   const [email, setEmail] = useState("");
//   const [phone, setPhone] = useState("");
